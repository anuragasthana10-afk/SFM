namespace CRM.Models.Clients
{
    ...
    public partial class ClientModel : Business.Clients.ClientContext
    {
        ...
        void init()
        {
            ...
            Workflow_StepDesignerLayouts = new FilteredDbSet<Workflow_StepDesignerLayout>(this, c => (c.DelFlag ?? false) == false);
            Workflow_TemplateAudits = new FilteredDbSet<Workflow_TemplateAudit>(this, c => true);
        ...
        public virtual IDbSet<Workflow_StepDesignerLayout> Workflow_StepDesignerLayouts { get; set; }
        public virtual IDbSet<Workflow_TemplateAudit> Workflow_TemplateAudits { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Workflow_StepDesignerLayout>()
                .Property(e => e.LastClientSyncDate)
                .HasPrecision(2);
            ...
            modelBuilder.Entity<Workflow_TemplateAudit>()
